...
let dailyQuestionCountPerUser = new Map();
export default async function openaiCall(content, messages = [], senderAddress, systemPrompt) {
    ...
    if (userDailyCount[today] >= 5) {
        ...
        return {
            reply: "Oops, looks like you've hit the 5-question cap! At this rate, my OpenAI key's gonna drain faster than Fabri's crypto funds. NGMI, try again tomorrow!",
            messages,
        };
    }
    try {
