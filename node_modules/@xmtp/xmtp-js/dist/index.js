import { ciphertext, privateKey, signature, publicKey, fetcher, keystore, message, content, authn, messageApi, invitation, contact, privatePreferences, composite } from '@xmtp/proto';
...
class CompositeCodec {
    ...
    decode(content, codecs) {
        return this.fromProto({ composite: composite.Composite.decode(content.content), part: undefined }, codecs);
    }
