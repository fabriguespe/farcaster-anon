...
const keyGateWayClient_js_1 = require("./keyGateWayClient.js");
...
`;
async function createNeynarSigner(apiKey, developerMnemonic) {
    ...
    const approveUrl = signer.signer_approval_url ?? '';
    console.log(await qrcode_1.default.toString(approveUrl, { type: 'terminal', small: true }));
    ...
    await ora.oraPromise((0, farcaster_js_neynar_1.waitForNeynarSignerApproval)(client, signerUuid), { spinner: 'bouncingBall' });
}
    ...
    program
        ...
        try {
            ...
            if (signerType.signerType === 'developer') {
                ...
                await (0, keyGateWayClient_js_1.createDeveloperSigner)(mnemonic.mnemonic);
            }
            else {
