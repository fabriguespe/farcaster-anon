...
export declare class NotificationsApi extends BaseAPI {
     ...
     */
    notifications(requestParameters: NotificationsApiNotificationsRequest, options?: AxiosRequestConfig): Promise<globalAxios.AxiosResponse<NotificationsResponse, any>>;
}
