...
const UserApiAxiosParamCreator = function (configuration) {
    return {
        ...
        farcasterUserVerificationDelete: async (removeVerificationReqBody, options = {}) => {
            ...
            (0, common_js_1.assertParamExists)('farcasterUserVerificationDelete', 'removeVerificationReqBody', removeVerificationReqBody);
            ...
            localVarRequestOptions.data = (0, common_js_1.serializeDataIfNeeded)(removeVerificationReqBody, localVarRequestOptions, configuration);
            return {
        ...
        farcasterUserVerificationPost: async (addVerificationReqBody, options = {}) => {
            ...
            (0, common_js_1.assertParamExists)('farcasterUserVerificationPost', 'addVerificationReqBody', addVerificationReqBody);
            const localVarPath = `/farcaster/user/verification`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_js_1.DUMMY_BASE_URL);
            let baseOptions;
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers };
            localVarRequestOptions.data = (0, common_js_1.serializeDataIfNeeded)(addVerificationReqBody, localVarRequestOptions, configuration);
            return {
                url: (0, common_js_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        followUser: async (followReqBody, options = {}) => {
            ...
            (0, common_js_1.assertParamExists)('followUser', 'followReqBody', followReqBody);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers };
            localVarRequestOptions.data = (0, common_js_1.serializeDataIfNeeded)(followReqBody, localVarRequestOptions, configuration);
            return {
                url: (0, common_js_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        lookupUserByCustodyAddress: async (custodyAddress, options = {}) => {
            ...
            (0, common_js_1.assertParamExists)('lookupUserByCustodyAddress', 'custodyAddress', custodyAddress);
        ...
        unfollowUser: async (followReqBody, options = {}) => {
            // verify required parameter 'followReqBody' is not null or undefined
            (0, common_js_1.assertParamExists)('unfollowUser', 'followReqBody', followReqBody);
            const localVarPath = `/farcaster/user/follow`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, common_js_1.DUMMY_BASE_URL);
            let baseOptions;
        ...
        updateUser: async (updateUserReqBody, options = {}) => {
            ...
            (0, common_js_1.assertParamExists)('updateUser', 'updateUserReqBody', updateUserReqBody);
            ...
            let headersFromBaseOptions = baseOptions && baseOptions.headers ? baseOptions.headers : {};
            localVarRequestOptions.headers = { ...localVarHeaderParameter, ...headersFromBaseOptions, ...options.headers };
            localVarRequestOptions.data = (0, common_js_1.serializeDataIfNeeded)(updateUserReqBody, localVarRequestOptions, configuration);
            return {
                url: (0, common_js_1.toPathString)(localVarUrlObj),
                options: localVarRequestOptions,
            };
        ...
        userBulk: async (fids, viewerFid, options = {}) => {
            ...
            (0, common_js_1.assertParamExists)('userBulk', 'fids', fids);
        ...
        userSearch: async (viewerFid, q, options = {}) => {
            ...
            (0, common_js_1.assertParamExists)('userSearch', 'viewerFid', viewerFid);
            // verify required parameter 'q' is not null or undefined
            (0, common_js_1.assertParamExists)('userSearch', 'q', q);
...
class UserApi extends base_js_1.BaseAPI {
     ...
     */
    farcasterUserVerificationDelete(requestParameters, options) {
        return (0, exports.UserApiFp)(this.configuration).farcasterUserVerificationDelete(requestParameters.removeVerificationReqBody, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Adds verification for an eth address for the user \\ (In order to add verification `signer_uuid` must be approved)
     * @summary Adds verification for an eth address for the user
     ...
     */
    farcasterUserVerificationPost(requestParameters, options) {
        return (0, exports.UserApiFp)(this.configuration).farcasterUserVerificationPost(requestParameters.addVerificationReqBody, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Follow a user \\ (In order to follow a user `signer_uuid` must be approved)
     * @summary Follow a user
     ...
     */
    userBulk(requestParameters, options) {
        return (0, exports.UserApiFp)(this.configuration).userBulk(requestParameters.fids, requestParameters.viewerFid, options).then((request) => request(this.axios, this.basePath));
    }
    /**
     * Search for Usernames
     * @summary Search for Usernames
     ...
     */
    userSearch(requestParameters, options) {
        return (0, exports.UserApiFp)(this.configuration).userSearch(requestParameters.viewerFid, requestParameters.q, options).then((request) => request(this.axios, this.basePath));
    }
}
