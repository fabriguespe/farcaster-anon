...
export declare class NotificationsApi extends BaseAPI {
     ...
     */
    mentionsAndReplies(requestParameters: NotificationsApiMentionsAndRepliesRequest, options?: AxiosRequestConfig): Promise<globalAxios.AxiosResponse<MentionsAndRepliesResponse, any>>;
    /**
     * Get a list of reactions and recasts to the users’s casts in reverse chronological order
     * @summary Get reactions and recasts
     * @param {NotificationsApiReactionsAndRecastsRequest} requestParameters Request parameters.
     ...
     * @memberof NotificationsApi
     */
    reactionsAndRecasts(requestParameters: NotificationsApiReactionsAndRecastsRequest, options?: AxiosRequestConfig): Promise<globalAxios.AxiosResponse<ReactionsAndRecastsResponse, any>>;
}
