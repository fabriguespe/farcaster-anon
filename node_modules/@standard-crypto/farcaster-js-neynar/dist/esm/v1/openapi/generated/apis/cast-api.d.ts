...
export declare class CastApi extends BaseAPI {
     ...
     * @memberof CastApi
     */
    allCastsInThread(requestParameters: CastApiAllCastsInThreadRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<AllCastsInThreadResponse, any>>;
    /**
     * Gets information about an individual cast
     * @summary Retrieve cast for a given hash
     * @param {CastApiCastRequest} requestParameters Request parameters.
     ...
     * @memberof CastApi
     */
    cast(requestParameters: CastApiCastRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CastResponse, any>>;
    /**
     * Gets the most recent casts for a user
     * @summary Retrieve casts for a given user
     * @param {CastApiCastsRequest} requestParameters Request parameters.
     ...
     * @memberof CastApi
     */
    casts(requestParameters: CastApiCastsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CastsResponse, any>>;
    /**
     * Get a list of casts from the protocol in reverse chronological order based on timestamp
     * @summary Get Recent Casts
     * @param {CastApiRecentCastsRequest} requestParameters Request parameters.
     ...
     * @memberof CastApi
     */
    recentCasts(requestParameters?: CastApiRecentCastsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<RecentCastsResponse, any>>;
}
