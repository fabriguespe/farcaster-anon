...
export declare class ReactionApi extends BaseAPI {
     ...
     */
    deleteReaction(requestParameters: ReactionApiDeleteReactionRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<OperationResponse, any>>;
    /**
     * Post a reaction (like or recast) to a given cast \\ (In order to post a reaction `signer_uuid` must be approved)
     * @summary Posts a reaction
     * @param {ReactionApiPostReactionRequest} requestParameters Request parameters.
     ...
     * @memberof ReactionApi
     */
    postReaction(requestParameters: ReactionApiPostReactionRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<OperationResponse, any>>;
}
