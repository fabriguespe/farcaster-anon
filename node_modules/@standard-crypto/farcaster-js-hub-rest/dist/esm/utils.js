import { ViemLocalEip712Signer, NobleEd25519Signer } from '@farcaster/core';
import { privateKeyToAccount, mnemonicToAccount } from 'viem/accounts';
import { createPublicClient, http } from 'viem';
import { mainnet } from 'viem/chains';
export function hexToSigner(signerHex) {
    let privateKeyBytes;
...
export function eip712SignerFromMnemonicOrPrivateKey(mnemonicOrPrivateKey) {
    let account;
    if (mnemonicOrPrivateKey.startsWith('0x')) {
        account = privateKeyToAccount(mnemonicOrPrivateKey);
    }
