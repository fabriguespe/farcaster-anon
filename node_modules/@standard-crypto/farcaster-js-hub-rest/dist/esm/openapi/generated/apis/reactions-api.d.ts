...
export declare class ReactionsApi extends BaseAPI {
     ...
     */
    getReactionById(requestParameters: ReactionsApiGetReactionByIdRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<Reaction, any>>;
    /**
     *
     * @summary Get all reactions to a cast
     * @param {ReactionsApiListReactionsByCastRequest} requestParameters Request parameters.
     ...
     * @memberof ReactionsApi
     */
    listReactionsByCast(requestParameters: ReactionsApiListReactionsByCastRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListReactionsByCast200Response, any>>;
    /**
     *
     * @summary Get all reactions by an FID
     * @param {ReactionsApiListReactionsByFidRequest} requestParameters Request parameters.
     ...
     * @memberof ReactionsApi
     */
    listReactionsByFid(requestParameters: ReactionsApiListReactionsByFidRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListReactionsByCast200Response, any>>;
    /**
     *
     * @summary Get all reactions to a target URL
     * @param {ReactionsApiListReactionsByTargetRequest} requestParameters Request parameters.
     ...
     * @memberof ReactionsApi
     */
    listReactionsByTarget(requestParameters: ReactionsApiListReactionsByTargetRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListReactionsByCast200Response, any>>;
}
