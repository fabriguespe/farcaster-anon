...
export declare class CastsApi extends BaseAPI {
     ...
     * @memberof CastsApi
     */
    getCastById(requestParameters: CastsApiGetCastByIdRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<CastAdd, any>>;
    /**
     *
     * @summary Fetch all casts authored by an FID.
     * @param {CastsApiListCastsByFidRequest} requestParameters Request parameters.
     ...
     * @memberof CastsApi
     */
    listCastsByFid(requestParameters: CastsApiListCastsByFidRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListCastsByFid200Response, any>>;
    /**
     *
     * @summary Fetch all casts that mention an FID
     * @param {CastsApiListCastsByMentionRequest} requestParameters Request parameters.
     ...
     * @memberof CastsApi
     */
    listCastsByMention(requestParameters: CastsApiListCastsByMentionRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListCastsByFid200Response, any>>;
    /**
     *
     * @summary Fetch all casts by parent cast\'s FID and Hash OR by the parent\'s URL
     * @param {CastsApiListCastsByParentRequest} requestParameters Request parameters.
     ...
     * @memberof CastsApi
     */
    listCastsByParent(requestParameters?: CastsApiListCastsByParentRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListCastsByFid200Response, any>>;
}
