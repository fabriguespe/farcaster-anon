...
export declare class HubEventsApi extends BaseAPI {
     ...
     */
    getEventById(requestParameters: HubEventsApiGetEventByIdRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<HubEvent, any>>;
    /**
     *
     * @summary Get a page of Hub events
     * @param {HubEventsApiListEventsRequest} requestParameters Request parameters.
     ...
     * @memberof HubEventsApi
     */
    listEvents(requestParameters?: HubEventsApiListEventsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ListEvents200Response, any>>;
}
