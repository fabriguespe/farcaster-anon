...
export declare class UsernamesApi extends BaseAPI {
     ...
     */
    getUsernameProof(requestParameters: UsernamesApiGetUsernameProofRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<UserNameProof, any>>;
    /**
     *
     * @summary Get a list of proofs provided by an FID
     * @param {UsernamesApiListUsernameProofsByFidRequest} requestParameters Request parameters.
     ...
     * @memberof UsernamesApi
     */
    listUsernameProofsByFid(requestParameters: UsernamesApiListUsernameProofsByFidRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<UsernameProofsResponse, any>>;
}
