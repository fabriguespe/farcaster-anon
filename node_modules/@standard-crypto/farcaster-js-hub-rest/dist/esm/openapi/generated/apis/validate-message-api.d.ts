...
export declare class ValidateMessageApi extends BaseAPI {
     ...
     */
    validateMessage(requestParameters: ValidateMessageApiValidateMessageRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ValidateMessageResponse, any>>;
}
